...
<!-- -------------------------------------------------------------------------- Navbar ------------------------------------------------------------------------------------------------------------------------ -->
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav"> -->
            ...
            <a class="navbar-brand me-auto ms-2 notes-academy" href="home.jsp"><b>Notes Academy</b></a>
  ...
  //                        Loop 1 - Categories loop
                  ...
                  <li class="dropstart">
                    ...
                    <ul class="dropdown-menu shadow-lg">
                            ...
                            %>
                                    ...
                                    <li><a class="dropdown-item" href="display_notes_selectedcourse.jsp?category=<%=d.getCategoryName()%>&courseid=<%=e.getCourseId()%>&course=<%=e.getCourseName().replaceAll("\\s+", "-")%>"><%= e.getCourseName() %></a></li>
              ...
              <!-- Dashboard -->
              <li class="nav-item">
                <a class="nav-link" href="admin_home.jsp">Dashboard</a>
              </li>

              
        <!-- PROFILE -->
        <li class="nav-item dropdown" style="padding-right: 5em;">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false"><%= us.getUserName() %></a>
                  
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <li class="dropdown-item "><a href="admin_user_notes.jsp?uid=<%=us.getUserId() %>" style="color: black; text-decoration: none;">My Notes</a></li>
