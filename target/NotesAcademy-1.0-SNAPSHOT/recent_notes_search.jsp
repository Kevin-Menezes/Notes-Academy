<%-- 
    Document   : recent_notes_search
    Created on : 10 Feb, 2022, 6:51:55 PM
    Author     : nivek
--%>
    ...
    <body class="d-flex flex-column min-vh-100">
        ...
        <div class="container mb-4">
            <div class="row text-center" style="margin-top:1em;">
                <h2 class="mb-2 text-start"><b>Showing results for " <%= ch %> "</b><a id="addnotebtn" class="btn px-3 py-2 ms-1 ms-sm-4 mt-4 mt-sm-0 shadow" data-bs-toggle="modal"  data-bs-target="#sendnotesModal"><b><span>Add note </span></b></a>
                    ...
                    <div class="dropdown" style="display: inline-block;">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark"  style="background-color: black" aria-labelledby="dropdownMenuButton1" >
                            <li><a class="dropdown-item" href="search.jsp?ch=<%=request.getParameter("ch") %>" >No filter</a></li>
                            <li><a class="dropdown-item" href="mostliked_notes_search.jsp?ch=<%=request.getParameter("ch") %>" >Most liked</a></li>
                        </ul>
                ...
                <%
                    ...
                    List<Note> list = dao.getRecentSearchNotes(ch);
                    
                    int mostdownloaded = ddao.getMostDownloadedNoteSearch(ch);
                    int mostliked = ldao.getMostLikedNoteSearch(ch);
                    int mostviewed = vdao.getMostViewedNoteSearch(ch);
                  ...
                  %>
                        ...
                        <h3 class="text-center mt-3">Kindly contact us if you feel that this website is missing a particular subject!</h3>
                ...
                <%
                    ...
                    int mostdownloadedpaid = ddao.getMostDownloadedPaidNoteSearch(ch);
                    int mostlikedpaid = ldao.getMostLikedPaidNoteSearch(ch);
                    
                    List<Note> list1 = dao.getRecentSearchNotes(ch);
                    for(Note b : list1){
                        if(b.getNotePrice()>0)
                        {
                %>
...
<!------------------------------------------------------------------------------- ELSE ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    %>
        ...
        <div class="container mb-4">
            <div class="row text-center" style="margin-top:1em;">
                <h2 class="mb-2 text-start"><b>Showing results for " <%= ch %> "</b><a id="addnotebtn" class="btn px-3 py-2 ms-1 ms-sm-4 mt-4 mt-sm-0 shadow" onclick="showAlert();" href="#BackToTop"><b><span>Add note </span></b></a>
