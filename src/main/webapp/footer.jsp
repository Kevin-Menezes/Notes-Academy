...
<div class="container mt-lg-5 text-white pt-3 pt-sm-5 pb-3 ">
    <div class="row">
        <div class="col-12 col-lg-6">
            ...
            <p>Notes Academy is a platform that manages and provides study notes, projects, question papers, YouTube lecture links, etc. which can be quickly accessed by any college going student. You can also upload your notes which will be beneficial to others in need of notes.</p>
        </div>
