                        ...
                        <form action="EditUserServlet" method="post">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="form-group col-sm-6">      
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="Username" placeholder="Enter username"  name="uname" required="required" value="<%=b.getUserName() %>">
                                </div>
                                ...
                                <div class="form-group col-sm-6 mt-3">
                                    ...
                                    <input class="form-control form-control-sm" list="datalistOptions" id="Profession" placeholder="Enter your profession" aria-describedby="passwordHelpInline" name="uprof" value="<%=b.getUserProfession() %>">
                                ...
                                <div class="form-group col-sm-6 mt-3">  
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="Clg" placeholder="Enter college/institute name" name="uclg" value="<%=b.getUserCollege() %>">
                                </div>
                                <div class="col-sm"></div> <!--THIS IS FOR THE EXTRA SPACE-->
