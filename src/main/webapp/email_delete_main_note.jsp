<%-- 
    Document   : email_delete_main_note
    Created on : 11 Mar, 2022, 11:52:50 AM
    Author     : nivek
--%>
                ...
                <div class="card p-0">
                    ...
                    <div class="card-body">
                        ...
                        <%
                            ...
                            UserDetails b = dao.getUserById(uid);
                        %>
                        
                        <!--Edit Category form-->
                        <form action="MainNotesDeleteServlet?nid=<%= nid %>&nfile=<%= filePath %>" method="post">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="form-group col-12 mt-3">    
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="Subject" placeholder="Enter subject" name="emailsubject" value="Hey <%=b.getUserName() %>, apologies for not accepting your notes!">
                                </div>
