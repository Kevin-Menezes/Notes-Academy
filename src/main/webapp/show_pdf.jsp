<%-- 
    Document   : show_pdf
    Created on : 30 Jan, 2022, 8:37:08 PM
    Author     : nivek
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row col-12">
                <div class="top-bar py-3" style="margin-top: 5em;">
                    ...
                    <a href="" onclick="doLike(<%= noteId %>,<%= userId %>,<%= nuserId %>)" class="btn btn-outline-dark ms-2 mb-1 "><i class="far fa-thumbs-up"></i>&nbsp; <%= b.getLikeCount() %></a>
                    <a href="DownloadServlet?fileName=<%= b.getFilePath() %>&noteId=<%= noteId %>&userId=<%= userId %>&nuserId=<%= nuserId %>" class="btn btn-primary ms-2 mb-1 "><i class="fas fa-download"></i>&nbsp; Download</a>
        ...
        <div class="fb-comments" data-href="http://localhost:8080/NotesAcademy/show_pdf.jsp?fileName=resourcesmain\Complete%20Python%20notes.pdf&noteId=4&userId=3&nuserId=1" data-width="10" data-numposts="5"></div>
