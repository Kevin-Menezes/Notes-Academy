                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="form-group col-12">                     
                            <input type="text" class="form-control form-control-sm" id="CategoryName" placeholder="Enter category name" name="catname" required="required" pattern="[A-Za-z\s]{3,20}" oninvalid="this.setCustomValidity('Enter 3 to 20 characters. No numbers & special characters allowed!')" oninput="this.setCustomValidity('')">
                        </div>
                        ...
                        <div class="form-group col-12  mt-1">                    
                            <input type="file" class="form-control-file " name="catimage" id="file" accept="image/*"  />
                        </div>
