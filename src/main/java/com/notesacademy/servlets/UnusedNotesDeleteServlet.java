...
public class UnusedNotesDeleteServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        {
            System.out.println("There is error in UnusedNotesDeleteServlet : "+mex);
        }   
        ...
        try 
        {
            ...
            if(f)
            {
                try{
                    ...
                    System.out.println("deletedddddddddddddddddddddddddddd");
                }
                catch(Exception e)
                {
                    ...
                    response.sendRedirect("delete_unused_notes.jsp"); 
            }
            else
            {
        ...
        {
            System.out.println("There is error in UnusedNotesDeleteServlet : "+e);
        }
