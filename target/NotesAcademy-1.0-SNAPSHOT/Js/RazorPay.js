function razorPopup(price,razorid,filepath,uname,ntitle,curruname,curruemail,noteId,userId,nuserId)
{
...
//                                    document.razorpayForm.submit();
                                    location.replace("DownloadServlet?fileName="+filename+"&noteId="+noteId+"&userId="+userId+"&nuserId="+nuserId);
                                },
