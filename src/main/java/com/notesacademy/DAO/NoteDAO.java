...
public interface NoteDAO 
{
    ...
    public List<Note> getNotesByUserId(int id) ; // Displaying all notes of a particular user
    
    public List<Note> getUnusedNotes() ; // Displaying all unused notes whose views are less than 10
    
    public boolean deleteMainNote(int id); // Deleting note from note table
