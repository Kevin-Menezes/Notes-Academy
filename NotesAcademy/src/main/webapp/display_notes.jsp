<%-- 
    ...
    Created on : 20 Jan, 2022, 9:09:37 AM
    Author     : nivek
--%>
                    ...
                    <div class="d-flex flex-row justify-content-around flex-wrap">
                        ...
                        <div class="card mt-4 shadow-lg" style="width: 24rem;"> <!--BOOTSTRAP CARD-->
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <a href="display_notes_selectedcourse.jsp?category=<%=b.getCategoryName()%>&courseid=<%=c.getCourseId()%>&course=<%=c.getCourseName().replaceAll("\\s+", "-")%>" class="card-link"><li class="list-group-item"><%=c.getCourseName()%></li></a>
