...
function verifyPassword()
            ...
            function showAlert()
            {
                if ($("#myAlert2").length == 0) {
                    $("#myAlert2").append("<div class='alert alert-warning alert-dismissible fade show mt-5' id='myAlert2' role='alert'> <button type='button' class='btn-close' data-bs-dismiss='alert'  aria-hidden='true'></button>Kindly signup or login to add notes!</div>");
                }
