...
public class UserDAOImpl implements UserDAO 
{
    ...
    // ------------------------------------------------ Updates user rank based on user id ---------------------------------------------
    
    @Override
    public boolean updateUserRank(int uid) 
    {
        ...
        try 
        {
            ...
            String sql1 = "UPDATE note SET userRank = userRank + 1 WHERE userId = ?";
            PreparedStatement ps_incUserRank = con.prepareStatement(sql1);
            ps_incUserRank.setInt(1,uid);
            ps_incUserRank.executeUpdate();
            
            String sql2 = "UPDATE user SET userRank = userRank + 1 WHERE userId = ?";
            PreparedStatement ps_incUserRank2 = con.prepareStatement(sql2);
            ps_incUserRank2.setInt(1,uid);
            ps_incUserRank2.executeUpdate();
        ...
        {
            System.out.println("There is error in UserDAOImpl - updateUserRank : "+e);
        }
        return f;
