                        ...
                        <form action="EditCategoryServlet" method="post">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="form-group col-12">   
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="editCategoryName" placeholder="Enter Category name" name="catname" value="<%= b.getCategoryName() %>" pattern="[A-Za-z\s]{3,20}" oninvalid="this.setCustomValidity('Enter 3 to 20 characters. No numbers & special characters allowed!')" oninput="this.setCustomValidity('')">
