                        ...
                        <form action="AddCourseServlet" method="post">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="form-group col-12">   
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="addCourseName" placeholder="Enter Course name" required="required" name="couname" pattern="[A-Za-z\s]{3,100}" oninvalid="this.setCustomValidity('Enter 3 to 100 characters. No numbers & special characters allowed!')" oninput="this.setCustomValidity('')">
