<%-- 
    ...
    Created on : 18 Jan, 2022, 10:45:47 AM
    Author     : nivek
--%>
    ...
    <body>
        ...
        <div class="container">
            <div class="row col-xl-4 col-lg-6 col-md-8 col-sm-10 col-12 ms-auto me-auto" style="margin-top:6em;">
                <div class="card p-0">
                    <h3 class="card-header  text-white" style="background-color: var(--green); ">ADD SUBJECT</h3>
                    <div class="card-body">
                        
                        <%
                            
                            int courseId = Integer.parseInt(request.getParameter("couid"));
                            String subjectYear = request.getParameter("syear").replaceAll("-", " ");
                        ...
                        <form action="AddSubjectServlet" method="post">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="form-group col-12">   
                                    <label for="addSubject" class="form-label">Subject name</label>
                                    <input type="text" class="form-control form-control-sm" id="addSubject" placeholder="Enter subject name" required="required" name="subname" pattern="[A-Za-z\s]{3,100}" oninvalid="this.setCustomValidity('Enter 3 to 100 characters. No numbers & special characters allowed!')" oninput="this.setCustomValidity('')">
                                    
                                    <label for="addSubjectYear" class="form-label mt-2">Subject year</label>
                                    <select name="subyear" class="form-select form-select-sm" id="editSubjectYear">     
                                        <option value="<%=subjectYear %>" selected hidden><%=subjectYear %></option>
                                    ...
                                    <input type="hidden" name="couid" value="<%= courseId %>">
                                </div>
                                ...
                                <div class="form-group d-flex justify-content-center">
                                    ...
                                    <a href="display_subjects.jsp" class="btn btn-dark col-5 col-sm-3 mt-4 ms-2" style="background-color: black;">Cancel</a>         
