<%-- 
    ...
    Created on : 16 Jan, 2022, 6:17:38 PM
    Author     : nivek
--%>
    ...
    <body>
        ...
        <div class="container">
            <div class="row col-xl-4 col-lg-6 col-md-8 col-sm-10 col-12 ms-auto me-auto" style="margin-top:6em;">
                <div class="card p-0">
                    <h3 class="card-header  text-white" style="background-color: var(--green); ">EDIT COURSE</h3>
                    <div class="card-body">
                        
                        <%
                            
                            int id = Integer.parseInt(request.getParameter("id"));
                            CourseDAOImpl dao = new CourseDAOImpl(DBConnection.getConnection());
                            Course b = dao.getCourseById(id);
                        %>
                        ...
                        <form action="EditCourseServlet" method="post">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="form-group col-12">   
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="editCourseName" placeholder="Enter Course name" required="required" name="couname" value="<%= b.getCourseName() %>" pattern="[A-Za-z\s]{3,100}" oninvalid="this.setCustomValidity('Enter 3 to 100 characters. No numbers & special characters allowed!')" oninput="this.setCustomValidity('')">
                                    <input type="hidden" name="couid" value="<%= b.getCourseId() %>">
                                </div>
