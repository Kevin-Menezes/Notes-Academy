                    ...
                    <div class="card" style="border-color: #6B9B8A;">
                        ...
                        <div class="card-body">           
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item text-center"><a href="DownloadServletApprove?fileName=<%= b.getFilePath() %>" class="btn btn-primary btn-sm"><i class="fas fa-download"></i>&nbsp; Download notes</a><small class="text-muted ms-2"><%= b.getNoteDate() %></small></li>
                            ...
                            <a href="show_admin_pdf.jsp?fileName=<%= b.getFilePath() %>" class="btn btn-outline-dark btn-sm col-10">View Note</a>
                            
                            <!-- BUTTON -->
                                <div class="form-group d-flex justify-content-center">
                                    <a href="ApproveNotesServlet?id=<%= b.getNoteId() %>"  class="btn btn-success col-5 col-sm-3 col-lg-5  mt-2">Add</a>                        
                                    <a href="email_delete_temp_note.jsp?nid=<%= b.getNoteId() %>&uid=<%= b.getUserId() %>&nfile=<%= b.getFilePath() %>" class="btn btn-dark col-5 col-sm-3 col-lg-5 mt-2 ms-2" style="background-color: black;">Delete</a>        
                                </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-4 mt-4">
                    <div class="card" style="border-color: #6B9B8A;">
                        ...
                        <div class="card-body">           
                            ...
                            <a href="show_admin_pdf.jsp?fileName=<%= b.getFilePath() %>" class="btn btn-outline-dark btn-sm col-10">More Info</a>
